...
sgx_status_t ecall_process_stats(const char* signed_data, uint32_t signed_data_len, uint8_t* signature_bin, int signer_type, uint8_t* ciphertext, uint32_t ciphertext_len, uint8_t* iv, uint32_t iv_len, uint8_t* mac, int op_code, double* result);
