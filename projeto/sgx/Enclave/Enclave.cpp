...
const uint8_t HOSPITAL_PUB_N[384] = {
    ,
};
...
sgx_status_t ecall_verify_signature(
    ...
    sgx_rsa3072_signature_t aligned_sig;
    memcpy(&aligned_sig, signature, sizeof(aligned_sig));
    ...
    char debug[128];
    snprintf(debug, sizeof(debug), "[Enclave] sgx_rsa3072_verify returned 0x%x, result = %d\n", ret, result);
    ocall_printf(debug);

    sgx_free_rsa_key(pub_key, SGX_RSA_PUBLIC_KEY,
                     SGX_RSA3072_KEY_SIZE, SGX_RSA3072_PUB_EXP_SIZE);

    *is_valid = (ret == SGX_SUCCESS && result == SGX_RSA_VALID);
    return ret;
}

bool verify_signature_rsa3072(
    const char* message,
    const uint8_t* signature_bin,
    const uint8_t* pub_n,
    const uint8_t* pub_e
) {
    if (!message || !signature_bin || !pub_n || !pub_e){
        ocall_printf("[Enclave] Invalid parameters\n");
        return false;
    }

    ocall_printf("[Enclave] verify_signature_rsa3072: start\n");
    ...
    if (ret != SGX_SUCCESS){
        ocall_printf("[Enclave] sgx_create_rsa_pub1_key failed\n");
        return false;
    }

    char debug_msg[64];
    snprintf(debug_msg, sizeof(debug_msg), "[Enclave] msg_len=%lu, sig_ptr=%p\n",
             strlen(message), signature_bin);
    ocall_printf(debug_msg);

    char hex[64];
    snprintf(hex, sizeof(hex), "[Enclave] sig[0..3]= %02X %02X %02X %02X\n",
             signature_bin[0], signature_bin[1], signature_bin[2], signature_bin[3]);
    ocall_printf(hex);
    ...
    ret = sgx_rsa3072_verify(
        ...
        (uint32_t)strlen(message),
        pub_key,
        (const sgx_rsa3072_signature_t*)signature_bin,
        &result
    );

    if (ret != SGX_SUCCESS){
        char buffer[64];
        snprintf(buffer, sizeof(buffer), "[Enclave] sgx_rsa3072_verify ret=0x%x\n", ret);
        ocall_printf(buffer);
    }

    if (result != SGX_RSA_VALID)
        ocall_printf("[Enclave] Signature INVALID\n");
    else
        ocall_printf("[Enclave] Signature VALID\n");

    sgx_free_rsa_key(pub_key, SGX_RSA_PUBLIC_KEY,
                     SGX_RSA3072_KEY_SIZE, SGX_RSA3072_PUB_EXP_SIZE);

    return (ret == SGX_SUCCESS && result == SGX_RSA_VALID);
}
...
sgx_status_t ecall_process_stats(
    ...
    if (!signed_data || !signature_bin || !ciphertext || !iv || !mac || !result || !pubkey_pem)
        return SGX_ERROR_INVALID_PARAMETER;

    std::string msg_str(signed_data, signed_data_len);
    std::vector<uint8_t> sig_vec(signature_bin, signature_bin + 384);
    std::vector<uint8_t> pem_vec(pubkey_pem, pubkey_pem + pubkey_len);
