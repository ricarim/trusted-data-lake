...
Para mitigar a vulnerabilidade, é necessário deixar de usar cifras de blocos CBC e adotar cifras mais seguras, como as que utilizam **AEAD** (Authenticated Encryption with Associated Data), disponíveis na versão 1.2 e obrigatórias na versão 1.3 do **TLS**, que já tem a proteção contra este ataque.
